...
namespace _2023_GC_A2_Partiel_POO.Level_2
{
    ...
    {
        public Punch() : base(TYPE.NORMAL, 70, StatusPotential.NONE, 75) { }
    }
    ...
    {
        public MegaPunch() : base(TYPE.NORMAL, 7000, StatusPotential.NONE, 20) { }
    }
    ...
    {
        public FireBall() : base(TYPE.FIRE, 50, StatusPotential.BURN, 40) { }
    }
    /// <summary>
    /// Attaque eau basique
    /// </summary>
    ...
    {
        public WaterBlouBlou() : base(TYPE.WATER, 20, StatusPotential.NONE, 90) { }
    }
    /// <summary>
    ...
    {
        public MagicalGrass() : base(TYPE.GRASS, 70, StatusPotential.SLEEP, 10) { }
    }
}
